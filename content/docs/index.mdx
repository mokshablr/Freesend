...
- **JavaScript/TypeScript SDK:** Official SDK with full TypeScript support, error handling, and intuitive API.
...
- **[API Reference](/docs/api/send-email)** - HTTP API documentation
- **[JavaScript/TypeScript SDK](/docs/sdk)** - Official SDK with examples and TypeScript support
- **[Configuration](/docs/configuration/mail-server)** - Mail servers, API keys, and more