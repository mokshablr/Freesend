...
| `base_url` | str | No | Custom base URL (defaults to `http://localhost:3000`) |
...
| `replyTo` | str | No | Reply-to email address |
| `cc` | str | No | CC recipient(s), comma-separated |
| `bcc` | str | No | BCC recipient(s), comma-separated |
