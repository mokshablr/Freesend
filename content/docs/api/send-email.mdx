...
> **Important**: For security reasons, Freesend only accepts attachments as base64-encoded content. Server-side file paths are no longer supported to prevent potential file system access vulnerabilities.
